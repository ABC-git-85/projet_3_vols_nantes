...
fig = px.bar(df_flight_nantes, x='MONTH_NAME', y='FLT_TOT_1', color='YEAR', barmode='group', labels={'FLT_TOT_1': "Vols", 'MONTH_NAME': "Mois", 'YEAR':'Année'}, title="🐘 Évolution du trafic aérien à Nantes en 2024", color_discrete_sequence=px.colors.qualitative.Plotly)
# Source
annotations = []
annotations.append(dict(xref='paper', yref='paper', x=0.5, y=-0.23,
                            xanchor='center', yanchor='top',
