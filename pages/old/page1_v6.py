...
def create_map(flight_data, airport_coords, radius_km):
    ...
    for flight in enriched_flights:
        ...
        folium.Marker(
            ...
            popup=folium.Popup(popup_text, max_width=500, min_width=300, parse_html=True),
                        ...
                        for info in timetable_data:
                            ...
                            if arrival_estimated:
                                try:
                                    ...
                                    estimated_arrival_time = datetime.fromisoformat(arrival_estimated)
                                    # Heure actuelle
                                    current_time = datetime.now()
                                    # Calcul du temps restant
                                    time_remaining = estimated_arrival_time - current_time
                                    # Si l'heure d'arrivée est passée, on met "Arrivé" ou un autre message
...
# Fonction pour appeler la météo
...
if chosen_airport_row['trigramme']:
    ...
    if weather_data and 'current' in weather_data:
        ...
        with col3:
            st.markdown(
                ...
                <div style="text-align: right; padding-right: 20px;">
                    <img src="{icon_url}" alt="{description}" style="max-width: 100px;">
                </div>
                """,
        ...
        with col4:
            ...
            st.write(f"**Vitesse du vent :** {wind_speed} km/h")
    else:
