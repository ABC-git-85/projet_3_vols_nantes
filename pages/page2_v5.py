...
kpi1.metric("Aéroports français", "🐓 63", "")
kpi2.metric("Vols 2024", "✈️ 1 707 533", "+1,46%")
...
kpi1.metric("Compagnies aériennes recensées à Nantes en 2024", "🧳 131", "")
kpi2.metric("Vols 2024", "✈️ 52 549", "+3,59%")
...
fig = px.bar(df_flight_nantes, x='MONTH_NAME', y='FLT_TOT_1', color='YEAR', barmode='group', text_auto=True, labels={'FLT_TOT_1': "Vols", 'MONTH_NAME': "Mois", 'YEAR':'Année'}, title="🐘 Évolution du trafic aérien à Nantes en 2024", color_discrete_sequence=px.colors.qualitative.Plotly)
# Source
annotations = []
annotations.append(dict(xref='paper', yref='paper', x=0.5, y=-0.23,
                            xanchor='center', yanchor='top',
